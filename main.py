...
history = model_multiple.fit(xtrain, ytrain, validation_data=(xtest, ytest), epochs=2)
time_end = time.time()
...
time_start = time.time()
history_single = model.fit(xtrain, ytrain, validation_data=(xtest, ytest), epochs=2)
time_end = time.time()
